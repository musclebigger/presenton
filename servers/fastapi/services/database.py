...
# Container DB (Lives inside the container or local user_data)
import sys
if sys.platform == "win32":
    # Windows: 使用 user_data 目录
    _container_db_path = os.path.join(
        os.environ.get("APP_DATA_DIRECTORY", "."), "container.db"
    )
